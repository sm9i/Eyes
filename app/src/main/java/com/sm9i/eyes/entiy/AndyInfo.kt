...
data class JenniferInfo(
    ...
    var refreshCount: Int,
    var lastStartId: Int,
    var issueList: MutableList<ContentBean>
) : Serializable
...
data class TabInfo(
    var tabList: MutableList<TabDetailInfo>,
    var defaultIdx: Int
) : Serializable


data class TabDetailInfo(
    var id: Int,
    var name: String,
    var apiUrl: String
) : Serializable
