 ...
 * 粘性头部+导航栏+viewpage
 */
class StickNavLayout : LinearLayout, NestedScrollingParent2 {
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        mCanScrollDistance =
            (mTopView.measuredHeight - resources.getDimension(R.dimen.normal_title_height).toInt()).toFloat()
    }
    ...
    override fun scrollTo(x: Int, y: Int) {
        ...
        Log.d(
            "wtf",
            "adJustY--> $adjustY   $mCanScrollDistance   --->${adjustY / mCanScrollDistance}"
        )
